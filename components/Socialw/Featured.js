        ...
        <div className="lg:col-span-7">
          ...
          <div className="grid grid-cols-12 gap-2 sm:gap-6 items-center lg:-translate-x-10">
            <div className="col-span-4">
              <Image className="rounded-xl" src="/insta.jpg" alt="Image Description" width={1920} height={1280}/>
            </div>
          
    
            <div className="col-span-3">
              <Image className="rounded-xl" src="/social4.jpg" alt="Image Description" width={1920} height={1280}/>
            </div>
           
    
            <div className="col-span-5">
              <Image className="rounded-xl" src="/mange.jpg" alt="Image Description" width={1920} height={1280}/>
            </div>
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="space-y-2 md:space-y-4">
              <h2 className="font-bold text-3xl lg:text-4xl text-gray-800 dark:text-gray-200">
               Social Media Management Na Karne Se Social Media Pages Ho Jatein Hai Dead💀!
              </h2>
              <p className="text-gray-500">
               isliye humne apke goals ko achieve karne ke liye social media expert ki team build ki hain jo every month apka social media channel ko boost karnge
              </p>
            </div>
            ...
            <ul role="list" className="space-y-2 sm:space-y-4">
              <li className="flex space-x-3">
                ...
                <span className="text-sm sm:text-base text-gray-500">
                  <span className="font-bold">YouTube</span> Channel Management
                </span>
              </li>
              ...
              <li className="flex space-x-3">
                ...
                <span className="text-sm sm:text-base text-gray-500">
                  B2B Leads <span className="font-bold">Linkedin Management</span>
                </span>
              </li>
            </ul>
