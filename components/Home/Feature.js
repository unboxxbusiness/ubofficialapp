...
<div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto bg-rose-900 dark:bg-gray-900 ">

  <div className="md:grid md:grid-cols-2 md:items-center md:gap-12 xl:gap-32">
    <div>
      <Image className="rounded-xl" src="/ubgirl.jpg" alt="Image Description" width={1920} height={1280}/>
    </div>
    ...
    <div className="mt-5 sm:mt-10 lg:mt-0">
      <div className="space-y-6 sm:space-y-8">
        ...
        <div className="space-y-2 md:space-y-4">
          <h2 className="font-bold text-3xl lg:text-4xl text-gray-100 dark:text-gray-200">
           Daily Coffee Cost 50 ☕ INR Se Kam Mein Apka Apna Custom Branded App
          </h2>
          <p className="text-gray-200">
          Business shuru karna Jitna Jruri Hain Sapno ke liye, Utna Hi Jaruri Hain business Ko Grow Karna Aur Aage Badhane Ke Liye zaruri Hain Digital Solutions Or Hum Affordable Cost Par Provide Karwate Kain Apko Yeh Sare Digital Solutions Jaise
          </p>
        </div>
        ...
        <ul role="list" className="space-y-2 sm:space-y-4">
          <li className="flex space-x-3">
            ...
            <span className="text-sm sm:text-base text-gray-200">
              <span className="font-bold">Website </span> Ya Apka Apna Custom App
            </span>
          </li>
          ...
          <li className="flex space-x-3">
            ...
            <span className="text-sm sm:text-base text-gray-200">
              Powerful <span className="font-bold">Social Media Management Services</span>
            </span>
          </li>
