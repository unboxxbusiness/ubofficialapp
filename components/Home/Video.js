...
<div className="relative overflow-hidden dark:bg-gray-950">
  <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10">
    <div className="max-w-2xl text-center mx-auto">
      <h1 className="block text-3xl font-bold text-gray-800 sm:text-4xl md:text-5xl dark:text-white">Business Offline Ho Ya Online<span className="text-blue-600">Dikhna Jruri Hain</span></h1>
      <p className="mt-3 text-lg text-gray-800 dark:text-gray-400">Business Owners Ke Liye Special Ek Video , Business Online Kyun Hain Jruri</p>
    </div>
